			...
			<table class="inputTable">
				...
				<tr class="authorityList">
					...
					<td>
						...
						<label>
							<input type="checkbox" name="role.authorityList" class="roleAuthorityList" value="ROLE_BUSIAREA"<#if (isAddAction || role.authorityList.contains("ROLE_BUSIAREA"))!> checked</#if> />商区管理
						</label>
						<label>
							<input type="checkbox" name="role.authorityList" class="roleAuthorityList" value="ROLE_SHOP"<#if (isAddAction || role.authorityList.contains("ROLE_SHOP"))!> checked</#if> />商铺管理
						</label>
					</td>
				</tr>
				<!--
