...
<!--
	...
	<div class="body">
		<div class="bodyLeft">
			<table class="listTable">
				...
				<tr>
					...
					<td>
						<a href="http://www.joyinwise.com">http://www.joyinwise.com</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<a href="http://bbs.joyinwise.com">http://bbs.joyinwise.com</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<a href="mailto:bug@joyinwise.com">bug@joyinwise.com</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<a class="red" href="http://www.joyinwise.com/license.html" target="_blank">[授权查询]</a>
					</td>
				</tr>
			</table>
			<div class="blank"></div>
		...
		<p class="copyright">Copyright © 2012-2020 joyinwise.com All Rights Reserved.</p>
	</div>
	-->
</body>
</html>