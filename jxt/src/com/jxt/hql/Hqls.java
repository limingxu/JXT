...
public interface Hqls {
	public interface AdminHqls {
		...
		String get_login_admin_by_username = "select a from Admin a left join fetch a.adminSchools b left join fetch b.school school left join fetch a.agent agent where a.username=:username and school.status=1 and agent.status=1 ";
