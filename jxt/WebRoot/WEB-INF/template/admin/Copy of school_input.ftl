...
<body class="input admin" onload="javascript:loadDistirct()">
	<div class="bar">
		...
		<form id="validateForm" action="<#if isAddAction>school!save.action<#else>school!update.action</#if>" method="post">
			...
			<table class="inputTable tabContent">
				...
				<tr>
					...
					<td>	
							<select id="citySel" name="school.city.id" class="selectText" width="180px" title="所在城市" onchange="javascript:loadDistirct()">
