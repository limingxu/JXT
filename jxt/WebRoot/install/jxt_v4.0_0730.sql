...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', '2013-07-29 22:02:07', '2013-07-30 22:57:02', null, null, null, 'admin@admin.com', '2013-07-30 22:57:02', '127.0.0.1', 'admin', '8ee751118fceaf13', null, null, 'ROLE_SYS_ADMIN', null, 'admin', '1', null, '');
...
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('1', NOW(), NOW(), '幼儿园', '幼班');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('2', NOW(), NOW(), '幼儿园', '中班');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('3', NOW(), NOW(), '幼儿园', '大班');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('4', NOW(), NOW(), '小学', '一年级');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('5', NOW(), NOW(), '小学', '二年级');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('6', NOW(), NOW(), '小学', '三年级');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('7', NOW(), NOW(), '小学', '四年级');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('8', NOW(), NOW(), '小学', '五年级');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('9', NOW(), NOW(), '小学', '六年级');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('10', NOW(), NOW(), '初中', '初一');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('11', NOW(), NOW(), '初中', '初二');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('13', NOW(), NOW(), '初中', '初三');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('14', NOW(), NOW(), '高中', '高一');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('15', NOW(), NOW(), '高中', '高二');
INSERT INTO `grade`(id,create_date,modify_date,phase,name) VALUES ('16', NOW(), NOW(), '高中', '高三');
